...
public class SystemConstant {
    ...
    public static final int CUSTOM_DATA_SETTING_IMAGE = 2;
    public static final int CUSTOM_DATA_SETTING_BOOLEAN = 3;
    public static final int CUSTOM_DATA_SETTING_BLOB = 4;
}
