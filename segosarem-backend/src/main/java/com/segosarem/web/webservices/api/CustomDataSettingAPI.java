...
public class CustomDataSettingAPI {
	...
	//Custom Data List
    // @ApiOperation(value = "Get list of custom data setting by custom data id", response = GeneralWsResponseBean.class)
    // @ApiResponses(value = {
	...
	@ResponseBody
	@RequestMapping(method = RequestMethod.POST, value = "/addCustomDataSetting", consumes = { "application/json" }, produces = {
			"application/json" })
	...
	@ResponseBody
	@RequestMapping(method = RequestMethod.POST, value = "/updateCustomDataSetting", consumes = { "application/json" }, produces = {
			"application/json" })
